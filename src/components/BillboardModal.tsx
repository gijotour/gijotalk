      ...
      <header className="flex justify-between items-center w-full z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-black text-lg tracking-tight font-['Montserrat'] text-white">
            GIJO Talk <span className="text-xs font-bold text-blue-400 bg-blue-950/60 px-2 py-0.5 border border-blue-800 rounded">GIJO LABS</span> <span className="text-xs font-normal text-ink-mute">| 3초 긴급 전광판</span>
          </span>
        </div>
        <button
          onClick={onClose}
