...
export const DriveModal: React.FC<DriveModalProps> = ({
  ...
  const handleExportCheatSheet = async () => {
    ...
    try {
      ...
      const categories = ['항공', '호텔', '교통', '식당', '흥정', '미팅/사교', '비상'];
      ...
      <div className="bg-white border-2 border-orange-100 rounded-3xl max-w-lg w-full p-6 text-slate-900 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
        ...
        <div className="overflow-y-auto py-4 space-y-4 flex-1 pr-1">
          ...
          {isAuthChecking ? (
            ...
            <div className="bg-[#FDFBF7] border-2 border-slate-100 rounded-2xl p-6 text-center space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-3 px-4 bg-white hover:bg-slate-50 border-2 border-slate-200 rounded-2xl text-slate-700 font-extrabold text-sm flex items-center justify-center gap-3 shadow-sm hover:shadow transition-all active:scale-98 disabled:opacity-50"
                >
                  {isLoggingIn ? (
            ...
            <div className="space-y-4">
              {/* Account Card */}
              <div className="bg-[#FDFBF7] border-2 border-orange-100 rounded-2xl p-4 flex items-center justify-between">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="p-4 bg-blue-500 hover:bg-blue-600 text-white rounded-2xl text-left flex flex-col justify-between h-28 shadow-sm transition-all disabled:opacity-50 active:scale-98"
                >
                  ...
                  <div>
                    <p className="font-black text-sm">Drive 백업 저장</p>
                ...
                <button
                  ...
                  disabled={actionLoading}
                  className="p-4 bg-[#FF6B4A] hover:bg-[#ff5a36] text-white rounded-2xl text-left flex flex-col justify-between h-28 shadow-sm transition-all disabled:opacity-50 active:scale-98"
                >
                  <div className="flex items-center justify-between w-full">
                  ...
                  <div>
                    <p className="font-black text-sm">{currentCountry.name} 치트시트</p>
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                    {files.map((f) => {
                      ...
                      return (
                        <div
                          key={f.id}
                          className="bg-white border border-slate-200 hover:border-blue-200 rounded-2xl p-3 flex items-center justify-between gap-3 shadow-2xs transition-all"
                        >
                          <div className="flex items-center gap-2.5 min-w-0">
                            <div
                              className={`p-2 rounded-xl shrink-0 ${
                                isJson ? 'bg-blue-50 text-blue-600' : 'bg-orange-50 text-[#FF6B4A]'
                              }`}
                            >
                              {isJson ? (
                          ...
                          <div className="flex items-center gap-1 shrink-0">
                            {isJson && (
                              <button
                                ...
                                disabled={actionLoading}
                                className="px-2.5 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 text-[11px] font-black rounded-xl transition-colors flex items-center gap-1"
                              >
        ...
        {fileToDelete && (
          <div className="absolute inset-0 bg-black/60 backdrop-blur-2xs rounded-3xl z-20 flex items-center justify-center p-4">
            <div className="bg-white border-2 border-rose-100 rounded-2xl p-5 max-w-xs w-full text-center space-y-3 shadow-xl animate-in zoom-in-95 duration-150">
              <div className="p-3 bg-rose-50 text-rose-600 rounded-2xl inline-block">
                <AlertCircle className="w-6 h-6" />
              </div>
              <h4 className="font-black text-sm text-slate-900">Google Drive 파일 삭제</h4>
              ...
              <div className="flex gap-2 pt-1">
                ...
                <button
                  ...
                  disabled={actionLoading}
                  className="flex-1 py-2 bg-rose-600 hover:bg-rose-700 text-white font-extrabold rounded-xl text-xs flex items-center justify-center gap-1 shadow-sm"
                >
                  {actionLoading ? (
