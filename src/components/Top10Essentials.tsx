...
// 🇻🇳 베트남 / 🇵🇭 필리핀 / 🇺🇸 영어 - 실제 원어민 오디오 음성과 100% 일치하는 정확한 발음과 텍스트
const ESSENTIALS_DATA: Record<string, EssentialData[]> = {
  vn: [
    { id: 'vn-soc-01', category: '미팅/사교', meaning: '안녕하세요, 잘 지내세요?', original: 'Chào anh/chị!', pronunciation: '짜오 아잉/찌!', tip: '베트남의 대표적인 표준 인사말', audio: 'vn/vn-soc-01.mp3' },
    { id: 'vn-12', category: '흥정', meaning: '정말 감사합니다!', original: 'Cảm ơn nhiều!', pronunciation: '깜 언 니에우!', tip: '가장 많이 쓰는 감사 표현', audio: 'vn/vn-12.mp3' },
    ...
    { id: 'vn-soc-15', category: '미팅/사교', meaning: '네, 만나서 반가워요', original: 'Vâng, rất vui được gặp anh/chị', pronunciation: '벙, 젓 부이 드억 갑 아잉/찌', tip: '정중한 긍정 및 첫인사', audio: 'vn/vn-soc-15.mp3' },
    { id: 'vn-soc-12', category: '미팅/사교', meaning: '아니요, 괜찮습니다 (사양할게요)', original: 'Tôi không quan tâm. Cảm ơn.', pronunciation: '또이 콤 꽌 떰. 깜 언', tip: '호객 행위를 정중히 거절할 때', audio: 'vn/vn-soc-12.mp3' },
  ...
  ph: [
    { id: 'ph-soc-01', category: '미팅/사교', meaning: '안녕하세요, 잘 지내세요?', original: 'Kumusta po kayo?', pronunciation: '쿠무스타 포 카요?', tip: '필리핀의 대표적인 정중한 일상 인사', audio: 'ph/ph-soc-01.m4a' },
    { id: 'ph-soc-03', category: '미팅/사교', meaning: '감사합니다! 친절하시네요.', original: 'Salamat po!', pronunciation: '살라맛 포!', tip: '가장 많이 쓰는 감사 인사 (po는 존칭)', audio: 'ph/ph-soc-03.m4a' },
    ...
    { id: 'ph-soc-18', category: '미팅/사교', meaning: '아니요, 괜찮습니다 (관심 없어요)', original: 'Hindi po ako interesado. Salamat.', pronunciation: '힌디 포 아코 인테레사도. 살라맛', tip: '호객 정중 거절', audio: 'ph/ph-soc-18.m4a' },
    { id: 'ph-02', category: '흥정', meaning: '이거 얼마인가요?', original: 'Magkano po ito?', pronunciation: '막카노 포 이토?', tip: '가격 문의', audio: 'ph/ph-02.m4a' },
    ...
    { id: 'ph-soc-15', category: '미팅/사교', meaning: '잘 가요, 다음에 또 만나요!', original: 'Magkita tayo ulit!', pronunciation: '막키타 타요 울릿!', tip: '작별 인사', audio: 'ph/ph-soc-15.m4a' },
  ],
  en: [
    { id: 'en-soc-04', category: '미팅/사교', meaning: '안녕하세요! 오늘 어떠세요?', original: 'Hi! How are you doing today?', pronunciation: '하이! 하우 아 유 두잉 투데이?', tip: '기본 인사', audio: 'en/en-soc-04.m4a' },
    { id: 'en-soc-01', category: '미팅/사교', meaning: '정말 감사합니다. 친절하시네요.', original: 'Thank you so much.', pronunciation: '땡큐 쏘 머치.', tip: '기본 감사', audio: 'en/en-soc-01.m4a' },
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-700 font-bold mt-0.5">
              공항·식당·호텔에서 바로 쓰는 1초 생존 표현 (정확한 원어민 음성 100% 탑재)
            </p>
          </div>
        </div>
      </div>
