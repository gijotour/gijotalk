...
//   4자리 숫자는 경우의 수가 1만 개뿐입니다. 해시를 손에 넣은 사람이 1만 개를
//   전부 넣어보면 결국 찾아냅니다. 그래서 PBKDF2 를 20만 회 돌려 한 번 시도에
//   시간이 걸리게 했습니다 — 전수 조사에 노트북 기준 약 8분입니다.
//
//   즉 이 잠금이 막는 것은 "주소를 우연히 알게 된 사람이 그냥 열어보는 것" 입니다.
//   작정한 사람은 뚫습니다. 진짜로 막아야 할 정보(여권번호 등)는 잠금을 믿지 말고
//   애초에 앱과 시트에 넣지 않는 편이 맞습니다.
//   보호 수준을 올리려면 자릿수를 늘리는 게 가장 효과적입니다 —
...
export const PASSCODE_HASH = 'Ivwwm1EUSSy29UK3NGm+FqpaoiWCpfilNm031/ZPxaw=';
